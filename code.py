...
def update_display():
    """Refresh the screen based on current view and update the NeoPixel lights."""
    magtag.set_text("", header_index)
    magtag.set_text("", content_index)
    # Clear the two pixels we are using: index 0 (left-most) and index 1 (second from right)
    ...
    if current_view == "weather":
        ...
        # Set the left-most pixel (index 0) to bright white
        ...
        # Set the left-most pixel (index 0) to bright blue
        ...
        # Always set left-most pixel to white in news view
        magtag.peripherals.neopixels[0] = (255, 255, 255)
        # Set second-from-right pixel (index 1) based on news_page:
        if news_page == 0:
            # First set: white
            ...
            # Third set: orange
            magtag.peripherals.neopixels[1] = (255, 165, 0)
    magtag.refresh()
...
def main():
    ...
    while True:
        ...
        # Button 2 (third from left): currently no functionality
